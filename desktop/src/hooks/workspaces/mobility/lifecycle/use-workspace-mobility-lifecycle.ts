import { useCloudWorkspaceHandoffHeartbeatLoop } from "@/hooks/workspaces/mobility/lifecycle/use-cloud-workspace-handoff-heartbeat-loop";
import { isWorkspaceMobilityTransitionPhase } from "@/lib/domain/workspaces/mobility/mobility-state-machine";
import { useWorkspaceMobilityState } from "../derived/use-workspace-mobility-state";
