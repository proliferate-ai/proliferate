...
export const CHAT_LINE_HEIGHT_REM = "1.125rem";
...
export const UI_FONT_SCALES: Record<UiFontSizeId, UiFontScale> = {
  xsmall: {
    ...
    chat: { fontSize: "0.5625rem", lineHeight: CHAT_LINE_HEIGHT_REM },
  ...
  small: {
    ...
    chat: { fontSize: "0.625rem", lineHeight: CHAT_LINE_HEIGHT_REM },
  ...
  default: {
    ...
    chat: { fontSize: "0.6875rem", lineHeight: CHAT_LINE_HEIGHT_REM },
  ...
  large: {
    ...
    chat: { fontSize: "0.75rem", lineHeight: CHAT_LINE_HEIGHT_REM },
  ...
  xlarge: {
    ...
    chat: { fontSize: "0.8125rem", lineHeight: CHAT_LINE_HEIGHT_REM },
  ...
  xxlarge: {
    ...
    chat: { fontSize: "0.875rem", lineHeight: CHAT_LINE_HEIGHT_REM },
