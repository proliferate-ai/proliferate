    ...
    <section className="space-y-3">
      ...
      <SettingsCard>
        ...
        <button
          ...
          disabled={!agentAuthByokCapabilityEnabled(capabilities)}
        >
          <Plus className="size-3.5" />
          {agentAuthByokCapabilityEnabled(capabilities)
            ? "Add credential - environment variable or org gateway"
...
function agentAuthByokCapabilityEnabled(
  capabilities: AgentGatewayCapabilities | null,
): boolean {
  return Boolean(
    ...
    && (
      capabilities.byokProviders.anthropicApiKey
