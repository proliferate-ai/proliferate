...
- [Self-hosted deployment](../developing/deploying/self-hosted-deploy.md) covers
  self-managed production deployment.
- [Sandbox foundation](../codebase/primitives/sandbox-provisioning.md) defines cloud
  target and managed sandbox ownership.
- [Agent auth](../codebase/primitives/agent-auth.md) defines sandbox-scoped agent
  LLM auth and gateway behavior.
- [MCP, skills, and plugins](../codebase/primitives/mcp-skills.md) defines
  sandbox-scoped runtime capability projection.
- [Cloud commands](../codebase/primitives/cloud-commands.md)
