...
| [support-system-alignment.md](support-system-alignment.md) | Historical live-system audit and superseded planning record. See the [accepted support-system contract](../codebase/systems/engineering/issue-lifecycle/support-loop.md). |
