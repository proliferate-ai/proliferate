...
| 10 | Runtime wake jobs | `cloud/runtime/wake.py` | **fire-and-forget `create_task`** in request path | wake a managed runtime slot for a command | ⚠️ no durability/retry; lost on restart | **Task** — durable queued — **Tier 1** |
