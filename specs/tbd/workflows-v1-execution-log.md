...
`ea4f5de5f`+log (WS0/WS1/WS0B-R/S/U, WS10a, WS2a all merged)
...
| --- | --- | --- | --- | --- |
| WS3a exact grants | agent (opus) | ~/proliferate-wt/wsc-ws3a | ea4f5de5f | running (owns next Alembic slot after d9578c0275f3) |
