...
- Frontend pure product decisions belong in `lib/domain/**`; multi-step
  ...
  `specs/codebase/structures/frontend/guides/lib.md:48`,
  `specs/codebase/structures/frontend/guides/hooks.md:73`).
- Zustand stores are client-only state and must not become remote caches; remote
  ...
  (`specs/codebase/structures/frontend/guides/state.md:12`,
  `specs/codebase/structures/frontend/guides/state.md:73`).
- Components should render and delegate product decisions/workflows to
  ...
  of component bodies (`specs/codebase/structures/frontend/guides/components.md:1`,
  `specs/codebase/structures/frontend/guides/copy.md:1`).
- Product hooks should consume existing access hooks and SDK React hooks rather
  ...
  (`specs/codebase/structures/frontend/guides/access.md:1`).
...
- Full-stack validation should use named dev profiles, for example
  ...
  sandboxes need to reach local callbacks (`specs/developing/local/dev-profiles.md:7`).
