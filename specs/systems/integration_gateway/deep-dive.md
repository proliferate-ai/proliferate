...
> [integration_gateway/README.md](README.md)
...
- Generic MCP session assembly belongs to [MCP runtime](../subagents/mcp-runtime.md).
- Sandbox lifecycle belongs to
  [lifecycle.md](../environments/README.md).
- Server vendor adapters follow the
  [Server integrations structure](../../areas/server.md).
