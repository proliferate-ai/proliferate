...
also read [delegated-work.md](../subagents/delegated-work.md).
...
`HarnessLaunchOptions` contract from `specs/systems/agent_auth/models.md`. After
...
[Workspace migration](../workspace-surface/migration.md).
