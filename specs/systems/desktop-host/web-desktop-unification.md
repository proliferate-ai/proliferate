...
to one `ProductHostProvider`. See [specs/systems/desktop-host/deep-dive.md](deep-dive.md)
...
See [specs/systems/desktop-host/deep-dive.md](deep-dive.md)
...
contract remains
[`specs/systems/desktop-host/deep-dive.md`](deep-dive.md).
