...
**Does not own:**
- AnyHarness runtime internals → [AnyHarness structure](../../areas/anyharness.md)
- Sandbox lifecycle and provisioning → [Sandbox lifecycle](../environments/README.md)
- Cloud workspace product flows → `Cloud workspace provisioning` (deleted, cull part 2)
- Server structure → [Server structure](../../areas/server.md)
...
> specified by [specs/systems/environments/seam.md](../environments/seam.md); this section keeps
...
Source: [Agent distribution](distribution.md) "Convergence" and "Runtime binary convergence (cloud)" sections
...
Source: [Worker lifecycle guide](../../areas/anyharness.md) "Launch Policy", `server/proliferate/server/cloud/runtime/bootstrap.py`
