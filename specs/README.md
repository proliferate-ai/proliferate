...
| Automated testing standard + qualification registry | `specs/developing/testing/README.md` (tiers, placement, gates), `specs/developing/testing/flows.md` (implemented flows), and `specs/developing/testing/core-release-validation.md` (complete Tier 2/3/4 target) |
