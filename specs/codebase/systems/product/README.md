...
| --- | --- |
| Onboarding | [onboarding/README.md](onboarding/README.md), with lower-level slices in [auth/README.md](auth/README.md), [specs/FEATURE_DOCS/BILLING.md](../../../FEATURE_DOCS/BILLING.md), and [settings/information-architecture.md](settings/information-architecture.md) (`workspace-provisioning.md` deleted, cull part 2). The managed model gateway is owned by [model_gateway/README.md](model_gateway/README.md). |
