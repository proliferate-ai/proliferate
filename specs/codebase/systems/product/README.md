...
| Mobile client | Mobile auth, cloud chat, sessions, and settings on the mobile surface. | No current system spec. Mobile ships from `apps/mobile`; architecture boundary owned by [structures/frontend](../../structures/frontend/README.md), local/QA lanes by [guides/local/mobile.md](../../../../guides/local/mobile.md). |
