...
| Model gateway | LiteLLM data plane, org enrollment and per-(member, harness) virtual keys, the LLM credit ledger, usage import, exhaustion, top-ups, verification; fences `ai_magic` as its control-plane consumer. | [model_gateway/README.md](model_gateway/README.md) |
| Integration gateway | Connections (definitions, OAuth, credentials at rest, health, management, admission, revocation, durable action approvals) and the MCP gateway (three virtual tools, per-call capability, audit). | [integration_gateway/README.md](integration_gateway/README.md) (Status: target) |
| GitHub | GitHub App user authorization, installations, repository authority, webhook intake, and the repo catalog — the identity of work. | [github/README.md](github/README.md) (Status: target) |
| Slack (product app) | The product Slack app as trigger + client over session bindings; not Slack-as-tool. | [slack/README.md](slack/README.md) (Status: target, skeleton) |
...
| --- | --- |
| Onboarding | [onboarding/README.md](onboarding/README.md), with lower-level slices in [auth/README.md](auth/README.md), [specs/FEATURE_DOCS/BILLING.md](../../../FEATURE_DOCS/BILLING.md), [../../platforms/product/workspace-provisioning.md](../../platforms/product/workspace-provisioning.md), and [settings/information-architecture.md](settings/information-architecture.md). The managed model gateway is owned by [model_gateway/README.md](model_gateway/README.md). |
