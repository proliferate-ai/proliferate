...
| Loading hero and session-loading wait treatment | [../ux-latency-transitions.md](../ux-latency-transitions.md) |
| Same-workspace subagents (Agents pane, tab hierarchy) | [../agents/delegated-work.md](../agents/delegated-work.md) |
...
2. **Agent auth / launch options** (runtime-observed, server-declared) —
   ...
   ([launch configuration authority](../../../../frontend/README.md#launch-configuration-authority)).
...
- Product telemetry events for turn end and reveal performance
  ...
  under the [telemetry](../../../../frontend/telemetry.md) privacy boundary).
...
- **Agent auth / models** owns identity and availability of models and
  ...
  ([MODELS.md](../../../../FEATURE_DOCS/MODELS.md), [AGENT_AUTH.md](../../../../FEATURE_DOCS/AGENT_AUTH.md)).
...
- Layer law: components render, hooks own behavior, `domain/chats` is pure
  and Mobile-safe ([frontend/README.md](../../../../frontend/README.md#what-goes-where)).
