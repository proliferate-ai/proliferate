...
- `specs/codebase/systems/product/clients/mobile-cloud.md` is the mobile behavior-parity
  reference.
- `specs/codebase/systems/product/chat/composer.md` and
  `specs/codebase/systems/product/chat/transcript.md` remain authoritative for composer
...
4. Start the profile from the worktree. On Pablo's machine, `pdev cloud` is an
   ...
   and database setup described in `specs/developing/local/dev-profiles.md`.
...
- Mobile smoke from `specs/codebase/systems/product/clients/mobile-cloud.md` for any mobile
  changes.
