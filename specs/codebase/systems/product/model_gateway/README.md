...
Sibling specs, one owner per concern: [agent_auth](../../../../FEATURE_DOCS/AGENT_AUTH.md)
...
company systems (MCP tools), not models; [billing](../../../../FEATURE_DOCS/BILLING.md)
owns compute segments, plans, credits for compute, and the Stripe
relationship; [harness launch options](../../../../FEATURE_DOCS/MODELS.md) owns which
...
- Selections, the key vault, `state.json` delivery, per-harness application
  and org agent-model policy: [agent_auth](../../../../FEATURE_DOCS/AGENT_AUTH.md).
...
- Compute segments, plans, Stripe customers, compute credits:
  [billing](../../../../FEATURE_DOCS/BILLING.md). Top-ups charge *through* billing.
