...
| --- | --- | --- |
| `create_run`, `wait_run`, `cancel_tree`, `record_result`, `attenuate` | [runs.md](../runs/README.md) | every run verb |
...
| spend / credit | billing ([BILLING.md](../../../../FEATURE_DOCS/BILLING.md)) | envelope enforcement at the billing gate |
...
| --- | --- |
| Run semantics, envelope math, results, spawn tree | [runs.md](../runs/README.md) |
...
| Human sign-in, sessions, refresh tokens | product auth ([auth/README.md](../auth/README.md)) |
