...
[product support](../../product/support/README.md) (the capture system this
...
- The report itself (`support_report` row, private S3 bundle, queue) is
  owned by [product support](../../product/support/README.md).
...
- **Testing** owns tiers, placement, and naming; this loop only requires
  the origin marker.
- **GitHub product system** (`specs/codebase/systems/product/github`) owns
