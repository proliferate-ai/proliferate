...
- low-level account auth routes and password/provider semantics, owned by
  [product-auth.md](product-auth.md)
...
- billing authorization and Stripe subscription/refill behavior, owned by
  [../primitives/billing.md](../primitives/billing.md)
- managed workspace creation, owned by
  [../primitives/workspace-provisioning.md](../primitives/workspace-provisioning.md)

## Read Order

1. This spec for the end-to-end onboarding sequence and boundaries.
2. [product-auth.md](product-auth.md) for sign-in methods, linked providers,
   password accounts, reviewer accounts, and GitHub readiness.
3. [settings-admin-ia.md](settings-admin-ia.md) for where account, provider,
   billing, team, and configuration states appear.
4. [../primitives/agent-auth-bifrost-byok.md](../primitives/agent-auth-bifrost-byok.md)
   for managed credits, BYOK, Bifrost virtual keys, and gateway QA.
5. [../primitives/billing.md](../primitives/billing.md) for credit budgets,
   free allocations, Stripe checkout, refill, and billing state.
6. [../primitives/workspace-provisioning.md](../primitives/workspace-provisioning.md)
   and [pending-workspace-shell.md](pending-workspace-shell.md) for first
