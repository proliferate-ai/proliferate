...
- `specs/codebase/features/mobile-cloud-client.md` is the mobile behavior-parity
  reference.
- `specs/codebase/features/chat-composer.md` and
  `specs/codebase/features/chat-transcript.md` remain authoritative for composer
...
- Mobile smoke from `specs/codebase/features/mobile-cloud-client.md` for any mobile
  changes.
