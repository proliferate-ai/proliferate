...
| Deployment capabilities | `/meta` capability contract versioning, independent GitHub repository access and managed-Cloud readiness, GitHub App completeness predicate, and repairable repo-authority statuses. | [deployment-capabilities.md](deployment-capabilities.md) |
...
| Managed model gateway | LiteLLM-backed managed credits, enrollment, virtual keys, usage import, and free credit allocation. | No current document; the Bifrost-era `agent-auth-bifrost-byok.md` described a never-shipped design and was removed. Owning code: `server/proliferate/integrations/litellm/`, `server/litellm/`. |
