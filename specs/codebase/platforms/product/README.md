...
| Sandbox content | Shared repo clones (create/refresh/reclaim), workspace worktrees (materialization, inventory, explicit archive/unarchive/purge, and orphan pruning), git identity, disk budget observability. | [content.md](../../../FEATURE_DOCS/SANDBOX/content.md) (Status: target) |
