...
| Deployment capabilities | Current `/meta` v3 capability contract, producer/consumer ownership, versioning, fail-closed compatibility, and local proof/gap. | [deployment-capabilities.md](deployment-capabilities.md). The target Sandbox access contract remains the destination migration context. |
