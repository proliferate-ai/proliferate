...
| Component library | The sanctioned component set (ui primitives/patterns/icons plus product-ui domain-aware patterns), tier placement and governance rules, the closed sanctioned index, and how a component enters the library. | [component-library.md](component-library.md) |
