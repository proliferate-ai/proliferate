...
in [`specs/engineering/testing/`](README.md).
...
success, in [`TESTING/core-release-validation.md`](core-release-validation.md#current-enforcement-exception).
...
dependency matrix lives in [`TESTING/release-worlds-and-fixtures.md`](release-worlds-and-fixtures.md#world-dependency-matrix).
...
and current-gap details live in [`TESTING/tier-4-scenario-contract.md`](tier-4-scenario-contract.md).
