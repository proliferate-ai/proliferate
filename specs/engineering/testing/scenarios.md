...
`specs/areas/anyharness.md`. Target
qualification owner: `specs/engineering/testing/tier-4-scenario-contract.md`.
...
`specs/engineering/testing/desktop-update-testing.md` ("Running the T4
scenario").
