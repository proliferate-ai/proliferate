<!-- DRAFT: launch-aligned README. Intended to replace README.md on the readme-revamp branch (#839).
     Alignment target: Show HN + Reddit posts (2026-07-06 launch) - same definition, same claims, same receipts.
     Asset TODOs still governed by specs/developing/assets/readme/SHOTLIST.md -->
