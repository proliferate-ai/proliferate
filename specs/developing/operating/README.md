...
| Add, change, or remove a third-party integration provider (seed definitions, static OAuth clients, tool policies) | [Integration Providers](integration-providers.md) |
