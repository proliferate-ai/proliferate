...
| `feature-wall/parallel-agents.{gif,jpg}` | One prompt fanned across 2–3 agents (Claude Code + Codex + Gemini), each in its own worktree; sidebar shows them running concurrently; end on the comparison view. |
