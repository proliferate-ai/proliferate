...
- **Lifecycle owns the sandbox primitives; billing owns the math.**
  [sandbox-lifecycle.md](../codebase/platforms/product/sandbox-lifecycle.md) names the events (create,
...
contract.** [sandbox-lifecycle.md](../codebase/platforms/product/sandbox-lifecycle.md#account-model) and
...
in
[`sandbox-lifecycle.md`](../codebase/platforms/product/sandbox-lifecycle.md#usage-fencing-the-billing-primitives)
...
- [ ] **B1.** `cloud_sandbox_value`
      ...
      [sandbox-lifecycle.md](../codebase/platforms/product/sandbox-lifecycle.md#current-gaps) — its gap
