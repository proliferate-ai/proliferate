...
- `docs/features/mobile-cloud-client.md` is the mobile behavior-parity
  reference.
- `docs/features/chat-composer.md` and
  `docs/features/chat-transcript.md` remain authoritative for composer
...
4. Start the profile from the worktree. On Pablo's machine, `pdev cloud` is an
   ...
   and database setup described in `docs/dev/reference/dev-profiles.md`.
...
- Mobile smoke from `docs/features/mobile-cloud-client.md` for any mobile
  changes.
