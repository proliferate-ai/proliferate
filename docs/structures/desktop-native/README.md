...
own product UI structure; use `docs/structures/frontend/README.md` for renderer code.
It does not own AnyHarness runtime internals; use `docs/structures/anyharness/README.md`
...
| Spec | Use it for |
| --- | --- |
| `docs/structures/desktop-native/specs/anyharness-sidecar.md` | How packaged Desktop bundles, finds, launches, monitors, and restarts the local AnyHarness runtime. |
| `docs/structures/desktop-native/specs/agent-seeds.md` | How bundled agent seeds are built, packaged, hydrated, tracked, repaired, and distinguished from downloaded artifacts. |
...
| Dev profiles | Profile-specific ports, Tauri config, app home, and runtime home come from `docs/dev/reference/dev-profiles.md`; do not hard-code default ports into new Tauri flows. |
