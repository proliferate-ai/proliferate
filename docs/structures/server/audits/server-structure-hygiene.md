...
- server structure docs under `docs/structures/server/**`
...
rules remain in `docs/structures/server/README.md` and the focused guides under
...
- `docs/structures/server/guides/database.md`
- `docs/structures/server/guides/workers.md`
...
- `docs/structures/server/guides/domains.md`
- `docs/structures/server/guides/database.md`
- `docs/structures/server/guides/workers.md`
...
- `docs/structures/server/guides/domains.md`
- `docs/structures/server/guides/database.md`
- `docs/structures/server/guides/integrations.md`
- `docs/structures/server/guides/workers.md`
- `docs/primitives/billing.md`
- `docs/structures/server/audits/phase6-billing-reconciler.md`
...
- `docs/structures/server/guides/integrations.md`
- `docs/structures/server/guides/workers.md`
- `docs/structures/server/audits/phase6-cloud-runtime-background-loops.md`
...
- `docs/primitives/claiming.md` when claim behavior is touched
...
- `docs/structures/server/guides/domains.md`
- `docs/structures/server/guides/auth.md`
- `docs/structures/server/guides/database.md`
- `docs/structures/server/guides/integrations.md`
- `docs/features/slack-bot.md`
...
Read first:
- docs/structures/server/README.md
- docs/structures/server/guides/<focused>.md
