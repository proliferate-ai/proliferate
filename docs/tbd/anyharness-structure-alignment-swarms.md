...
area. The canonical rules remain in `docs/structures/anyharness/**`,
`docs/primitives/**`, and `docs/features/product-mcps/**`.

Use `docs/tbd/structure-alignment-coordinator-model.md` with this document when
...
- `docs/structures/anyharness/guides/live-runtime.md`
- `docs/structures/anyharness/specs/session-engine.md`
- `docs/structures/anyharness/src/acp.md`
...
- `docs/structures/anyharness/guides/live-runtime.md`
- `docs/structures/anyharness/specs/session-engine.md`
- `docs/structures/anyharness/specs/session-actor.md`
- `docs/structures/anyharness/harnesses/claude.md`
- `docs/structures/anyharness/harnesses/codex.md`
...
- `docs/structures/anyharness/specs/session-engine.md`
- `docs/structures/anyharness/src/sessions.md`
...
- `docs/structures/anyharness/guides/domains.md`
- `docs/structures/anyharness/src/workspaces.md`
- `docs/primitives/workspace-lifecycle.md`
...
- `docs/structures/anyharness/guides/adapters.md`
- `docs/structures/anyharness/src/files.md`
- `docs/structures/anyharness/src/git.md`
...
- `docs/structures/anyharness/contract.md`
- `docs/structures/anyharness/guides/repo-shape.md`
...
- `docs/structures/anyharness/src/agents.md`
- `docs/structures/anyharness/harnesses/claude.md`
- `docs/structures/anyharness/harnesses/codex.md`
...
- `docs/features/cowork-artifacts.md`
