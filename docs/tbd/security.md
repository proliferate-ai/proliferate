...
- [Self-hosted deployment](../dev/reference/self-hosted-deploy.md) covers
  self-managed production deployment.
- [Sandbox foundation](../primitives/sandbox-provisioning.md) defines cloud
  target and managed sandbox ownership.
- [Agent auth](../primitives/agent-auth.md) defines sandbox-scoped agent
  LLM auth and gateway behavior.
- [MCP, skills, and plugins](../primitives/mcp-skills.md) defines
  sandbox-scoped runtime capability projection.
- [Cloud commands](../primitives/cloud-commands.md)
