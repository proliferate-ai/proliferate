...
standard. The canonical rules remain in `docs/structures/frontend/README.md`,
the focused guides under `docs/structures/frontend/guides/`, and
...
- Every workstream starts by reading:
  ...
  - `docs/structures/frontend/packages/README.md` when touching shared packages
  - feature specs under `docs/features/**` when touching a covered product
    surface
...
- Canonical docs:
  - `docs/structures/frontend/guides/components.md`
  - `docs/structures/frontend/guides/styling.md`
  - `docs/structures/frontend/packages/README.md`
- Goal:
...
- Canonical docs:
  ...
  - `docs/structures/frontend/guides/access.md`
  - `docs/structures/frontend/guides/lib.md`
  - `docs/features/chat-composer.md`
  - `docs/features/chat-transcript.md`
- Goal:
...
- Canonical docs:
  ...
  - `docs/structures/frontend/guides/access.md`
  - `docs/structures/frontend/guides/state.md`
  - `docs/features/mobile-cloud-client.md`
  - `docs/features/chat-composer.md`
  - `docs/features/chat-transcript.md`
- Goal:
...
- Canonical docs:
  ...
  - `docs/features/pending-workspace-shell.md`
- Goal:
...
- Canonical docs:
  ...
  - `docs/dev/ci-cd.md` if CI enforcement changes
- Goal:
...
`docs/tbd/structure-alignment-coordinator-model.md`. Use that document with
...
- `docs/structures/frontend/packages/README.md` if touching shared packages
...
- `docs/structures/frontend/README.md`
- `<FOCUSED_FRONTEND_GUIDES>`
- `docs/structures/frontend/packages/README.md` if the PR touches packages
