...
This document is in `docs/tbd/` while the design is being reviewed. When the
implementation lands, the durable contract should move to
`docs/primitives/cloud-worker-control-loop.md` or be folded into
`docs/primitives/cloud-commands.md` plus the worker focused guides.
