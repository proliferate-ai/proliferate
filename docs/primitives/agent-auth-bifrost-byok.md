...
- `docs/structures/server/guides/config.md`
- `docs/dev/reference/dev-profiles.md`
- `docs/dev/reference/env-secrets-matrix.md`
- `docs/primitives/sandbox-provisioning.md`
...
Follow `docs/structures/server/README.md` and focused guides:
...
`docs/dev/reference/env-secrets-matrix.md`, and `docs/dev/reference/env-vars.yaml`.
