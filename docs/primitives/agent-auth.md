...
- [`billing.md`](billing.md): managed-credit `included_budget_usd`
...
CODEX_API_KEY, CODEX_HOME, CURSOR_API_KEY, GEMINI_API_KEY, GOOGLE_API_KEY,
...
Chunk F  Capability API + Desktop selector cleanup
  ...
  - remove hardcoded AGENT_GATEWAY_BYOK_ENABLED
  - operator runbook update (docs/dev/reference/self-hosted-deploy.md)
