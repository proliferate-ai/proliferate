...
| Model gateway | `server/proliferate/server/agent_auth/{enrollment,usage_import,topups,budget,free_credits,worker,verification,migration}.py`, `server/litellm/**`, `server/proliferate/server/ai_magic/**` | [`specs/systems/ai_gateway/README.md`](specs/systems/ai_gateway/README.md) |
