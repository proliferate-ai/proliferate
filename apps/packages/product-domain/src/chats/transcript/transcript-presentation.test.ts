  ...
  it("treats raw cmd grep and read shell commands as quiet exploration", () => {
    ...
    transcript.itemsById = {
      ...
      read: terminalCmdItem(
        ...
        "turn-1",
        2,
        "sed -n '1,80p' apps/desktop/src/App.tsx",
        "completed",
      ),
  ...
  it("shows active Codex parsed read and search batches as collapsed exploration", () => {
    ...
    transcript.itemsById = {
      scan: parsedCommandItem("scan", "turn-1", 1, [
        {
          type: "read",
          cmd: "sed -n '1,200p' apps/desktop/src/components/workspace/chat/transcript/MessageList.tsx",
          name: "MessageList.tsx",
          path: "apps/desktop/src/components/workspace/chat/transcript/MessageList.tsx",
        },
        {
          type: "search",
          cmd: "rg useEffect apps/desktop/src",
          query: "useEffect",
          path: "apps/desktop/src",
        },
        {
          type: "search",
          cmd: "rg useStore apps/desktop/src",
          query: "useStore",
          path: "apps/desktop/src",
        },
      ]),
  ...
  it("expands active Codex ops shell batches into read and search rows", () => {
    ...
    transcript.itemsById = {
      scan: parsedCommandItem("scan", "turn-1", 1, [{
        ...
        cmd: [
          "ops=(",
          "  'rg \"<button\" apps/desktop/src/components -n'",
          "  'sed -n \"1,120p\" apps/desktop/src/components/AppShell.tsx'",
