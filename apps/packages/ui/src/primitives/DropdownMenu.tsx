...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "relative flex min-h-7 cursor-pointer select-none items-center gap-1.5 rounded-lg px-2.5 py-[5px] text-ui-sm outline-none [&_svg]:opacity-75 data-[highlighted]:[&_svg]:opacity-100 data-[highlighted]:bg-hover data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[variant=destructive]:text-destructive data-[inset]:pl-8",
        className,
      )}
      {...props}
    />
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "relative flex min-h-7 cursor-pointer select-none items-center gap-1.5 rounded-lg py-[5px] pl-8 pr-2.5 text-ui-sm outline-none data-[highlighted]:bg-hover data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        className,
      )}
      checked={checked}
      {...props}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "relative flex min-h-7 cursor-pointer select-none items-center gap-1.5 rounded-lg px-2.5 py-[5px] text-ui-sm outline-none [&_svg]:opacity-75 data-[highlighted]:[&_svg]:opacity-100 data-[highlighted]:bg-hover data-[state=open]:bg-hover data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8",
        className,
      )}
      {...props}
    >
...
function DropdownMenuSubContent({
  ...
  return (
    // Portalled like the main content: the parent panel is overflow-hidden,
    // so an in-place submenu panel would clip at the parent's edge.
    <DropdownMenuPrimitive.Portal>
