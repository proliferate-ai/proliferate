...
export const BILLING_PLAN_COLUMNS: BillingPlanColumn[] = [
  {
    key: "free",
    name: "Free",
    tagline: "Evaluation and personal cloud work.",
    price: "$0",
    suffix: "forever",
    ...
    highlights: [
      ...
      "Starter workflow access",
      "Personal cloud workspaces",
      "Hosted gateway auth",
  ...
  },
  {
    ...
    price: "Core",
    suffix: "organization plan",
    billing: "Checkout provisions the current Core plan in Stripe",
    featured: true,
    highlightsLabel: "Everything in Free, plus",
    highlights: [
      "Organization cloud billing",
...
export const BILLING_PLAN_SECTIONS: BillingPlanSection[] = [
  {
    ...
    rows: [
      { label: "Proliferate Credits", values: { free: "5 PCUs", core: "Core plan allowance", enterprise: "Custom" } },
      ...
      { label: "Members", values: { free: "Personal", core: "Organization", enterprise: "Organization" } },
