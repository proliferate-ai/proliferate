...
export const BILLING_PLAN_COLUMNS: BillingPlanColumn[] = [
  {
    key: "free",
    name: "Free",
    tagline: "Personal use and evaluation.",
    price: "$0",
    suffix: "forever",
  ...
  },
  {
    ...
    billing: "20 / 50 / 100 / 200 / 500 PCU packs with top up",
    featured: true,
    highlightsLabel: "Everything in Free, plus",
    highlights: [
      "Organization cloud billing",
      "20-500 monthly PCU packs",
...
export const BILLING_PLAN_SECTIONS: BillingPlanSection[] = [
  {
    ...
    rows: [
      ...
      { label: "Credit packs", values: { free: "Included", core: "20 / 50 / 100 / 200 / 500 PCUs", enterprise: "Custom" } },
