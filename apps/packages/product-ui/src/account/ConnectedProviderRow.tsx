  ...
  return (
    <div className={twMerge("flex items-center gap-3 border-b border-border-light px-4 py-3 last:border-b-0", className)} {...props}>
      <div className="min-w-0 flex-1">
        <div className="truncate text-body-emphasis font-medium text-foreground">{provider}</div>
        {detail && <div className="mt-0.5 truncate text-ui-sm text-muted-foreground">{detail}</div>}
      </div>
