...
export function CloudChatHeader({ header }: { header: CloudChatHeaderView }) {
  return (
    <>
...
function noticeToneClass(tone: CloudChatHeaderNoticeView["tone"]): string {
  switch (tone) {
    case "info":
      return "border-info/20 bg-foreground/5 text-foreground";
    case "destructive":
      return "border-destructive/25 bg-destructive-subtle text-foreground";
    case "warning":
    default:
      return "border-warning/20 bg-foreground/5 text-foreground";
  }
}
