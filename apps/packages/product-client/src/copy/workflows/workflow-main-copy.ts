...
export const WORKFLOW_MAIN_COPY = {
  ...
  createDialogLabel: "Create a new workflow",
  createDialogDescription:
    "Start from an empty graph, or from a template you can edit before saving.",
  blankWorkflowTitle: "Blank workflow",
  blankWorkflowDescription: "An input node and nothing else",
  templateGroupTitle: "Start from a template",
  templateMeta: (count: number) => `${count} ${count === 1 ? "step" : "steps"}`,
