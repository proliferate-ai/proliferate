import type { DiffLine, InterHunkGap } from "#product/lib/domain/files/diff-parser";
import type { ChatDiffRow, SplitDiffRow } from "#product/lib/domain/files/diff-view-rows";
import {
  clampGapReveal,
  resolveGapLineCount,
