...
export async function dispatchInteractionIntent(
  ...
  deps: Pick<InteractionIntentDispatchDeps, "resolveInteractionMutation" | "cloudClient">,
): Promise<void> {
...
export async function dispatchEditPendingPromptIntent(
  ...
  deps: Pick<InteractionIntentDispatchDeps, "editPendingPromptMutation" | "cloudClient">,
): Promise<void> {
  useSessionIntentStore.getState().patchIntent(intent.intentId, {
    status: "dispatching",
    errorMessage: null,
...
export async function dispatchDeletePendingPromptIntent(
  ...
  deps: Pick<InteractionIntentDispatchDeps, "deletePendingPromptMutation" | "cloudClient">,
): Promise<void> {
  useSessionIntentStore.getState().patchIntent(intent.intentId, {
    status: "dispatching",
    errorMessage: null,
