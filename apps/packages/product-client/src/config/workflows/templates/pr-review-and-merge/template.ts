import preparePullRequestPrompt from "./prompts/01-prepare-pull-request.md?raw";
import reviewPullRequestPrompt from "./prompts/02-review-pull-request.md?raw";
import addressReviewPrompt from "./prompts/03-address-review.md?raw";
import proveMergeReadinessPrompt from "./prompts/04-prove-merge-readiness.md?raw";
import approveMergePrompt from "./prompts/05-approve-merge.md?raw";
import mergePullRequestPrompt from "./prompts/06-merge-pull-request.md?raw";
