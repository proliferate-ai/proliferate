  ...
  return (
    <div className="flex h-full flex-col gap-5 px-6 pb-5 pt-4">
      <div className="flex items-start gap-4">
        <div className="flex size-14 shrink-0 items-center justify-center rounded-xl border border-border/60 bg-surface-elevated-secondary">
          <ProliferateIcon className="icon-display text-foreground [font-size:var(--text-sidebar-brand)]" />
        </div>
        <div className="min-w-0 pt-0.5">
          <h2 className="text-workspace-title font-semibold text-foreground">
            Update available
          </h2>
