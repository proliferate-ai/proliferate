...
export function FileChangesCard({
  ...
  return (
    <div
      className={`mb-2 flex flex-col overflow-hidden rounded-xl bg-[var(--color-diff-panel-surface)] text-readable-code text-foreground ${className ?? ""}`}
    >
      <div className="flex items-center gap-2">
        <div className="flex w-full min-w-0 flex-nowrap items-center gap-1 pr-1 pl-3">
          <span className="min-w-0 truncate py-2 text-chat text-foreground">
