 ...
 * pill. With `onOpen` it is a button that opens the agent; without it, a
 * focusable read-only chip. `closed` dims only the glyph — identity itself
 * never changes with presentation state.
 */
