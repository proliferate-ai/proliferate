    ...
    <PopoverButton
      ...
      trigger={(
        <Button
          ...
          className="size-8 rounded-lg text-sidebar-muted-foreground hover:bg-hover active:bg-active hover:text-sidebar-foreground data-[state=open]:bg-active data-[state=open]:text-sidebar-foreground"
        >
