  ...
  return (
    ...
    >
      ...
      <section
        ...
        aria-label={label}
        className={[
          "pointer-events-auto absolute bottom-2 right-2 top-2 flex min-w-0 flex-col overflow-hidden rounded-lg border border-border/80 bg-sidebar-background/95 shadow-popover backdrop-blur",
          widthClassName,
        ].join(" ")}
      >
        {children}
