...
export function ComposerOptionRow({
  ...
  return (
    <Button
      ...
      className={twMerge(
        "group/option flex w-full items-center gap-2.5 rounded-lg px-2 py-1.5 text-left transition-colors hover:bg-hover disabled:cursor-default disabled:opacity-60 disabled:hover:bg-transparent",
