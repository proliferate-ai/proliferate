...
import { CheckCircleFilled, Circle, ListChecks, Spinner } from "@proliferate/ui/icons";
...
export function TodoTrackerPanel({ entries }: TodoTrackerPanelProps) {
  ...
  const context = (
    <span className="flex items-center gap-2">
      <span className="h-0.5 w-10 shrink-0 overflow-hidden rounded-full bg-surface-control">
        <span
          data-todo-progress
