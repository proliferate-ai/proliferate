      ...
      <Tooltip content={tooltipContent} className="flex w-full">
        <Button
          ...
          className={twMerge(
            ...
            "flex w-full shrink-0 cursor-pointer items-baseline gap-2 overflow-hidden whitespace-normal rounded-lg px-2.5 py-1 text-left text-ui outline-none hover:bg-hover focus:bg-hover active:bg-active",
