      ...
      <div className="max-h-48 overflow-y-auto">
        {recoveries.map((recovery) => {
          ...
          return (
            ...
            // check 7): the slotted list-row shape this maps to renders a
            // `<button>` with its slots inside it, and this row hosts its own
            ...
            // non-interactive spelling of that shape, which is a review ruling.
            <div
              key={recovery.id}
