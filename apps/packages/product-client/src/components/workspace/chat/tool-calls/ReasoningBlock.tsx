    ...
    >
      {content ? (
        <ToolActionDetailsPanel>
          <div
            className={`overflow-y-auto select-text whitespace-pre-wrap break-words px-3 py-2 font-mono text-readable-code text-foreground ${TOOL_CALL_BODY_MAX_HEIGHT_CLASS}`}
          >
            {content}
          </div>
        </ToolActionDetailsPanel>
