...
describe("WorkflowsMainSurface", () => {
  it("renders a v2 row's title, description and updated-at, skipping gen-1 rows", () => {
    mocks.listQuery.data = {
      workflows: [
        listRow({ id: "wf-1", title: "Issue triage", description: "Triages new issues against the repo." }),
        listRow({ id: "wf-legacy", title: "Legacy workflow", schemaVersion: 1 }),
      ],
    };
    ...
    expect(screen.queryByText("Legacy workflow")).toBeNull();
  });
