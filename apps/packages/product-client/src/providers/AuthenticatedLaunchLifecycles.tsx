 ...
 * the attempts they park. None of it can exist for a signed-out viewer, so
 * the lifecycle root mounts this behind `React.lazy` + the authenticated gate
 * (the same treatment `AuthRestartOfferRoot` gets). That keeps the whole
 ...
 *
 * The registry-wide cloud poll loop that used to live here (PRO-230) is gone
 * with the cloud-workspace-creation surfaces it served (PRO-10 cull): no
 * attempt can reach `awaiting-cloud-ready` anymore.
 *
