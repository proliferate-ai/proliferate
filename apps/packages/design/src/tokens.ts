/**
 * Literal authority for Proliferate's web, code, motion, and native design inputs.
 * Generated CSS is a projection of these records; CSS source files must not
 * introduce a second global token value.
 */
...
/**
 * React Native-compatible dark palette. Overlapping roles project from the
 * web authority; only public mobile-only roles remain authored here.
 */
export const colors = {
  background: nativeColor("--color-background"),
  foreground: nativeColor("--color-foreground"),
  overlay: nativeColor("--color-overlay"),
  // Mobile-only scrim strength; the retired web overlay-strong token stays absent.
...
/** Resolved code-palette inputs for Shiki and Monaco adapters. */
