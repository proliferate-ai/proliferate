export const COMPUTE_COPY = {
  ...
  description: "SSH targets and personal machines available to cloud work you own.",
  ...
  testConnectionError: "Could not reach the target runtime over SSH.",
  ...
  directSshHelp: "How this desktop tunnels into the target's runtime. Stored locally on this device.",
