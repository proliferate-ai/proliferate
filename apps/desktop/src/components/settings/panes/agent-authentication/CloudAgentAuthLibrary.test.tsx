...
function makeLibraryState(overrides: Record<string, unknown> = {}) {
  return {
    ...
    ensuringManagedCredits: false,
    feedback: null,
    focusedAgentKind: null,
    handleEnsureFreeCredits: vi.fn(),
    handleEnsureManagedCredits: vi.fn(),
    ...
    isAdminForSelectedOrganization: false,
    localSourceError: null,
    localSourcesByProvider: new Map(),
    organizationCredentials: [],
    organizationCredentialsError: null,
    organizationCredentialsLoading: false,
    organizationOptions: [],
