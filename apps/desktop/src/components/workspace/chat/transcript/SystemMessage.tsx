...
export function SystemMessage({ content }: SystemMessageProps) {
  ...
  return (
    <div className="py-1.5">
      ...
      {systemExpanded && (
        <div
          className="mt-1 rounded-md border border-border bg-card px-3.5 py-2.5 font-sans text-ui-sm leading-[1.65] tracking-[-0.01em] whitespace-pre-wrap text-muted-foreground select-text"
        >
          {content}
        </div>
      )}
