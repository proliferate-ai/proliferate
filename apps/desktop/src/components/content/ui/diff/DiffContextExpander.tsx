...
export function DiffGapContentLabel({
  ...
  return (
    ...
    >
      <span className="shrink-0 text-ui-sm leading-none text-muted-foreground/70">
        {label}
      </span>
      {!isSmall && onExpand && (
        <Button
          ...
          title="Expand all"
          className="ml-1.5 shrink-0 cursor-pointer rounded border-0 bg-transparent px-1 py-0.5 text-ui-sm leading-none text-muted-foreground/60 transition-colors hover:text-foreground"
        >
          Expand all
        </Button>
      )}
...
export function DiffCollapsedContentLabel({
  ...
  return (
    <span
      ...
      className="flex w-max items-center gap-0.5 px-2"
    >
      <span className="shrink-0 text-ui-sm leading-none">
...
export function DiffCollapsedContextCluster({
  ...
  return (
    ...
    >
      ...
      <span className="shrink-0 pl-1 text-ui-sm leading-none">
        {formatUnmodifiedLinesLabel(lineCount)}
      </span>
    </span>
  );
...
export function DiffGapInfoRow({
  ...
  return (
    ...
    >
      <span
        style={{ position: "sticky", left: stickyLeft }}
        className="w-max px-2 text-ui-sm leading-none text-muted-foreground/50"
      >
        {formatUnmodifiedLinesLabel(lineCount)}
      </span>
    </div>
