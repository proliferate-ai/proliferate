...
export const GIT_REVIEW_V2_FILES: GitReviewV2File[] = [
  ...
  {
    key: "review-document",
    path: "apps/desktop/src/components/workspace/git/GitReviewDocument.tsx",
    status: "added",
    additions: 148,
    deletions: 0,
  ...
  {
    key: "use-collapse",
    path: "apps/desktop/src/hooks/workspaces/ui/git/use-review-collapse-state.ts",
    status: "added",
    additions: 36,
    deletions: 0,
  ...
  {
    key: "status-badge",
    path: "apps/desktop/src/components/workspace/git/GitReviewStatusBadge.tsx",
    status: "deleted",
    additions: 0,
    deletions: 46,
  ...
  {
    key: "file-section",
    path: "apps/desktop/src/components/workspace/git/GitReviewFileSection.tsx",
    oldPath: "apps/desktop/src/components/workspace/git/GitReviewFileRow.tsx",
    status: "renamed",
    additions: 8,
    deletions: 8,
  ...
  {
    key: "binary-icon",
    path: "apps/desktop/src-tauri/app-icons/vscode.png",
    status: "binary",
    additions: 0,
    deletions: 0,
    patch: null,
