...
describe("parseGitHubLink", () => {
  it("recognizes common GitHub link shapes without network metadata", () => {
    ...
    expect(parseGitHubLink("https://github.com/proliferate-ai/proliferate/blob/main/apps/desktop/src/App.tsx"))
      .toMatchObject({
        kind: "file",
        label: "proliferate-ai/proliferate/apps/desktop/src/App.tsx",
        typeLabel: "File",
      });
  });
