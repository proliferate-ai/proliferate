...
import { useDirectAuthStateSync } from "@/hooks/agents/lifecycle/use-direct-auth-state-sync"
...
function AppRuntime() {
  ...
  recordBootDiagnosticOnce("app_runtime.render.before.use_direct_auth_state_sync")
  useDirectAuthStateSync()
  recordBootDiagnosticOnce("app_runtime.render.after.use_direct_auth_state_sync")
