...
export type ProductRoutesComponent = ComponentType<{ children: ReactNode }>
...
function App({ RoutesComponent = Routes }: { RoutesComponent?: ProductRoutesComponent }) {
  return (
    <AppErrorBoundary>
      <ProductLifecycleRoot>
        <AppRuntime RoutesComponent={RoutesComponent} />
      </ProductLifecycleRoot>
    </AppErrorBoundary>
  )
}

function AppRuntime({ RoutesComponent }: { RoutesComponent: ProductRoutesComponent }) {
  return (
