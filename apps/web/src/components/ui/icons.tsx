...
/**
 * Gmail icon (reuses Google colors with envelope shape)
 */
export function GmailIcon({ className }: IconProps) {
	return (
		<svg className={className} viewBox="0 0 24 24" fill="none">
			...
			<path d="M22 6L12 13L2 6V4L12 11L22 4V6Z" fill="#FBBC05" />
			<path d="M2 4C2 2.9 2.9 2 4 2H20C21.1 2 22 2.9 22 4L12 11L2 4Z" fill="#4285F4" />
		</svg>
	);
}
...
export function NotionIcon({ className }: IconProps) {
	return (
		<svg className={className} viewBox="0 0 24 24" fill="currentColor">
			<path d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L18.16 2.3c-.42-.326-.98-.7-2.055-.607L3.01 2.96c-.466.046-.56.28-.374.466l1.823 1.782zm.793 3.358v13.9c0 .747.373 1.027 1.214.98l14.523-.84c.841-.046.935-.56.935-1.167V6.727c0-.606-.233-.933-.748-.886l-15.177.886c-.56.047-.747.327-.747.84zm14.337.745c.093.42 0 .84-.42.888l-.7.14v10.264c-.608.327-1.168.514-1.635.514-.748 0-.935-.234-1.495-.933l-4.577-7.186v6.952l1.448.327s0 .84-1.168.84l-3.222.187c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.82 9.76c-.094-.42.14-1.026.793-1.073l3.456-.234 4.764 7.28v-6.44l-1.215-.14c-.093-.514.28-.886.747-.933l3.224-.187zM2.24.95L16.66 0c2.055-.187 2.568.14 3.41.746l4.717 3.31c.606.42.793.56.793 1.027v16.56c0 1.027-.373 1.634-1.682 1.727L7.537 24c-.98.046-1.448-.093-1.962-.747l-3.129-4.057c-.56-.747-.793-1.307-.793-1.96V2.77C1.653 1.744 2.006.996 2.24.95z" />
		</svg>
	);
}
...
export function SalesforceIcon({ className }: IconProps) {
	return (
		<svg className={className} viewBox="0 0 24 24" fill="#00A1E0">
			<path d="M10.006 5.415c.81-.876 1.935-1.424 3.183-1.424 1.615 0 3.015.884 3.77 2.196.656-.295 1.377-.461 2.138-.461 2.94 0 5.321 2.388 5.321 5.333s-2.381 5.334-5.321 5.334c-.338 0-.668-.032-.987-.094-.647 1.082-1.832 1.81-3.183 1.81-.598 0-1.16-.141-1.66-.392-.651 1.476-2.128 2.51-3.845 2.51-1.594 0-2.988-.896-3.693-2.21-.259.035-.523.054-.791.054-3.05 0-5.524-2.476-5.524-5.53s2.474-5.53 5.524-5.53c.926 0 1.798.229 2.565.633.7-1.093 1.914-1.822 3.297-1.822.073 0 .145.002.217.007z" />
		</svg>
	);
}
...
export function GoogleCalendarIcon({ className }: IconProps) {
	return (
		<svg className={className} viewBox="0 0 24 24" fill="none">
			...
			<rect x="2" y="4" width="20" height="5" fill="#1967D2" />
			<rect x="6" y="11" width="4" height="3" rx="0.5" fill="white" />
			<rect x="6" y="15.5" width="4" height="3" rx="0.5" fill="white" />
			<rect x="14" y="11" width="4" height="3" rx="0.5" fill="white" />
			<rect x="14" y="15.5" width="4" height="3" rx="0.5" fill="white" />
			<rect x="7" y="1" width="2" height="5" rx="1" fill="#4285F4" />
			<rect x="15" y="1" width="2" height="5" rx="1" fill="#4285F4" />
		</svg>
	);
}
...
export function GoogleDriveIcon({ className }: IconProps) {
	return (
		<svg className={className} viewBox="0 0 24 24" fill="none">
			<path d="M8.007 1.5L0 15.004h7.992L16.01 1.5H8.007z" fill="#0066DA" />
			<path d="M16.01 1.5L8.007 15.004H24L16.01 1.5z" fill="#00AC47" />
			<path d="M0 15.004L3.998 22.5H20.002L24 15.004H0z" fill="#FFBA00" />
		</svg>
	);
}
...
export function HubSpotIcon({ className }: IconProps) {
	return (
		<svg className={className} viewBox="0 0 24 24" fill="#FF7A59">
			<path d="M17.002 8.394V5.718c.907-.378 1.547-1.27 1.547-2.309 0-1.39-1.125-2.516-2.515-2.516S13.52 2.02 13.52 3.41c0 1.039.64 1.93 1.547 2.308v2.677c-1.142.196-2.18.671-3.034 1.358L5.236 4.564c.064-.221.103-.451.103-.69C5.34 2.84 4.5 2 3.467 2 2.433 2 1.593 2.84 1.593 3.874c0 1.033.84 1.873 1.874 1.873.316 0 .612-.082.876-.221l6.656 5.093c-.714 1.028-1.139 2.276-1.139 3.62 0 1.372.44 2.642 1.184 3.68l-2.048 2.048c-.199-.065-.407-.107-.626-.107-.985 0-1.783.798-1.783 1.783s.798 1.783 1.783 1.783 1.783-.798 1.783-1.783c0-.219-.042-.427-.107-.626l2.019-2.019c1.104.824 2.465 1.314 3.94 1.314 3.674 0 6.653-2.98 6.653-6.653 0-3.395-2.546-6.193-5.836-6.592l-.747-.078zm-.968 10.656c-2.218 0-4.017-1.798-4.017-4.016 0-2.218 1.799-4.017 4.017-4.017 2.217 0 4.016 1.799 4.016 4.017 0 2.218-1.799 4.016-4.016 4.016z" />
		</svg>
	);
}
