...
import { MobileWorkspaceActionOptionRow } from "./MobileWorkspaceActionSheetRows";

export function MobileWorkspaceActionControlDetail({
  control,
  onBack,
  onSelect,
}: {
          ...
          return (
            <View key={group.id} style={styles.optionGroup}>
              ...
              {group.options.map((option) => (
                <MobileWorkspaceActionOptionRow
                  key={option.id}
                  option={option}
