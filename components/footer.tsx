...
export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-zinc-800 bg-black">
      <div className="proliferate-container py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-12 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start gap-4">
            <Link href="/" className="flex items-center space-x-2">
              <Image
                ...
                className="h-8 w-8"
              />
              <span className="font-bold text-white">Proliferate</span>
            </Link>
            ...
            <div className="flex gap-4 mt-2">
              ...
              <Link href="https://www.linkedin.com/company/withproliferate" aria-label="LinkedIn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-zinc-400 hover:text-white transition-colors">
          ...
          <div className="flex flex-col items-center sm:items-start gap-3">
            ...
            {/* <Link href="https://docs.withproliferate.com" className="text-sm text-zinc-400 hover:text-white transition-colors">
              Docs
            </Link> */}
            {/* <Link href="https://status.withproliferate.com" className="text-sm text-zinc-400 hover:text-white transition-colors">
              Status
            </Link> */}
          </div>
          ...
          <div className="flex flex-col items-center sm:items-start gap-3">
            ...
            <Link href="mailto:founders@withproliferate.com" className="text-sm text-zinc-400 hover:text-white transition-colors">
              Contact
            </Link>
            {/* <div className="flex gap-3 mt-2">
              <Link href="https://github.com/withproliferate" aria-label="GitHub">
              ...
              <Link href="https://slack.com/withproliferate" aria-label="Slack">
                <svg className="h-5 w-5 text-zinc-400 hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center gap-4 mt-12 pt-8 border-t border-zinc-800">
          <p className="text-sm text-zinc-500 text-center">
            © {currentYear} Proliferate. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
