...
const envValues = {
  ...
  STRIPE_CHECKOUT_SUCCESS_URL: "http://localhost:5174/settings?section=billing&checkout=success",
  STRIPE_CHECKOUT_CANCEL_URL: "http://localhost:5174/settings?section=billing&checkout=cancel",
  STRIPE_CUSTOMER_PORTAL_RETURN_URL: "http://localhost:5174/settings?section=billing",
};
