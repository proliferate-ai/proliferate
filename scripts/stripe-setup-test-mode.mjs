...
const envValues = {
  ...
  STRIPE_CHECKOUT_SUCCESS_URL: "http://127.0.0.1:5174/settings/billing?checkout=success",
  STRIPE_CHECKOUT_CANCEL_URL: "http://127.0.0.1:5174/settings/billing?checkout=cancel",
  STRIPE_CUSTOMER_PORTAL_RETURN_URL: "http://127.0.0.1:5174/settings/billing",
};
