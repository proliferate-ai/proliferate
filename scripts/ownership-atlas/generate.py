...
OWNERSHIP: list[Region] = [
    ...
    Region("anyharness/crates/anyharness-lib/src/domains/agents", "domains/agents", "harnesses", "body", "owned", "agent_auth's runtime cell moved to domains/agent_auth (Wave-3, slice 6b)", "Runtime — AnyHarness (Rust)"),
    Region("anyharness/crates/anyharness-lib/src/domains/agent_auth", "domains/agent_auth", "agent_auth", "keys", "owned", "route_auth · auth · auth_state · launch_probe; the Wave-3 move landed", "Runtime — AnyHarness (Rust)"),
