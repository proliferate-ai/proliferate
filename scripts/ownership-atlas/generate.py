...
OWNERSHIP: list[Region] = [
    ...
    Region(
        "server/proliferate/server/setup",
        "server/setup",
        "identity",
        "keepers",
        "owned",
    ...
    Region(
        "server/proliferate/server/integration_gateway",
    ...
    Region(
        "server/proliferate/server/github",
        "server/github",
        "github",
        "keys",
        "owned",
    ...
    Region(
        "server/proliferate/server/repositories",
        "server/repositories",
        "github",
        "keys",
        "owned",
    ...
    Region(
        "server/proliferate/server/seam",
        "server/seam",
        "environments",
        "place",
        "owned",
    ...
    Region(
        ...
        "",
        "unowned",
        "gateway proxy, dark; keep-vs-delete ruling pending",
        "Server — control plane (Python)",
    ),
    Region(
    ...
    Region(
        "server/proliferate/server/devtools",
        "server/devtools",
        "engineering/ci-cd",
        "engineering",
        "owned",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/domains/artifacts",
        "domains/artifacts",
        "sessions",
        "atom",
        "owned",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/domains/activity",
        "domains/activity",
        "sessions (observers)",
        "atom",
        "owned",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/domains/goals",
        "domains/goals",
        "sessions (observers)",
        "atom",
        "owned",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/domains/loops",
        "domains/loops",
        "sessions (observers)",
        "atom",
        "owned",
    ...
    Region(
        ...
        "domains/agents",
        "harnesses ∧ agent_auth",
        "body",
        "shared",
        "route_auth · auth · auth_state · launch_probe are agent_auth's; Wave-3 move ruled",
        "Runtime — AnyHarness (Rust)",
    ),
    Region(
        "anyharness/crates/anyharness-lib/src/adapters",
        "adapters/",
        "machinery: mechanism adapters — git · files · processes · hosting (an adapter with an opinion is a bug; multi-consumer, NOT harnesses')",
        "areas",
        "owned",
        "",
        "Runtime — AnyHarness (Rust)",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/domains/agent_operations",
        "domains/agent_operations",
        "subagents",
        "body",
        "",
        "",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/domains/terminals",
        "domains/terminals",
        "workspaces",
        "body",
        "owned",
    ...
    Region(
        ...
        "api/ (http · sse · ws)",
        "each route file → its domain's spec (sessions, harnesses, agent_auth, …)",
        "areas",
        "shared",
        "multi-owner by rule, permanently — what it awaits is an enforcement checker, not a code move",
        "Runtime — AnyHarness (Rust)",
    ),
    Region(
        "anyharness/crates/anyharness-lib/src/domains/materialization",
        "domains/materialization",
        "—",
        "",
        "unowned",
        "owner TBD in harnesses/subagents pass",
        "Runtime — AnyHarness (Rust)",
    ),
    Region(
    ...
    Region(
        ...
        "",
        "unowned",
        "one-review-system ruling pending",
        "Runtime — AnyHarness (Rust)",
    ),
    Region(
        "anyharness/crates/anyharness-lib/src/domains/mobility",
        "domains/mobility",
        "—",
        "",
        "unowned",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/app",
        "app/",
        "machinery: wiring (areas/anyharness)",
        "areas",
        "owned",
        "",
        "Runtime — AnyHarness (Rust)",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/persistence",
        "persistence/",
        "machinery: SQLite layer (areas/anyharness)",
        "areas",
        "owned",
        "",
        "Runtime — AnyHarness (Rust)",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/observability",
        "observability/",
        "machinery: telemetry plumbing (areas/anyharness)",
        "areas",
        "owned",
        "",
        "Runtime — AnyHarness (Rust)",
    ...
    Region(
        "anyharness/crates/anyharness-lib/src/integrations",
        "integrations/",
        "machinery: vendor leaves (areas/anyharness)",
        "areas",
        "owned",
        "",
        "Runtime — AnyHarness (Rust)",
    ...
    Region(
        ...
        "anyharness-contract",
        "machinery: wire contracts, generated",
        "areas",
        "owned",
        "",
        "Runtime — AnyHarness (Rust)",
    ...
    Region(
        ...
        "apps/packages/product-client",
        "chat · workspace-surface · runs-triage · settings · onboarding",
        "windows",
        "shared",
        "chat · workspace-surface · runs-triage · settings · onboarding — per-surface re-fence is Wave 4",
        "Clients (TypeScript)",
    ),
    Region(
    ...
    Region(
        ...
        "",
        "unowned",
        "retire vs re-point, ruling pending",
        "Clients (TypeScript)",
    ),
    Region(
        "cloud/sdk",
        "cloud/sdk",
        "machinery: generated CP client",
        "areas",
        "owned",
        "",
        "Clients (TypeScript)",
    ...
    Region(
        ...
        "server/…/db",
        "machinery: db (alembic tree; every migration owned by the system whose rows change)",
        "areas",
        "owned",
        "",
        "Server plumbing · data · engineering",
    ...
    Region(
        ...
        "server/…/background",
        "machinery: celery (every task owned by its system)",
        "areas",
        "owned",
        "",
        "Server plumbing · data · engineering",
    ...
    Region(
        ...
        "server/…/integrations",
        "machinery: vendor leaves (no product logic — the contract deserves its own page)",
        "areas",
        "owned",
        "",
        "Server plumbing · data · engineering",
    ...
    Region(
        ...
        "server/…/lib",
        "machinery: shared lib (declared consumers only)",
        "areas",
        "owned",
        "",
        "Server plumbing · data · engineering",
