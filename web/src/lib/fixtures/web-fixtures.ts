import { demoChats, demoCurrentUser, demoWorkspaces } from "@proliferate/product-model/chats/fixtures";
import type { ChatKind, ProductChat, ProductUser, ProductWorkspace } from "@proliferate/product-model/chats/model";
