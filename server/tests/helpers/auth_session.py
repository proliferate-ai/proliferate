"""Test-user creation and desktop-token login for integration suites.

Relocated from the deleted cloud e2e helpers; the integrations, gateway, and
worker suites still seed users this way.
"""
