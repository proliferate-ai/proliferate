...
def test_schedule_signup_slack_notification_does_not_raise_when_create_task_fails(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    def broken_create_task(*_args: object, **_kwargs: object) -> object:
        raise RuntimeError("no running loop")

    monkeypatch.setattr(notifications.asyncio, "create_task", broken_create_task)
