...
async def assert_current_schema(conn: AsyncConnection, head_revision: str) -> None:
    ...
    assert tables >= {
        ...
        "agent_gateway_llm_usage_event", "agent_gateway_router_materialization",
        "agent_gateway_runtime_grant", "agent_gateway_usage_import_cursor",
        ...
        "provider_grant",
        "auth_challenge",
        "sso_connection", "sso_challenge", "sso_identity",
        "oauth_account",
        "organization",
