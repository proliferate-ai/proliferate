...
class Settings(BaseSettings):
    ...
    # workspace_move (specs/tbd/workspace-migration-v2.md section 2.2): mirrors the
    # AnyHarness engine's MAX_MOBILITY_ARCHIVE_BODY_BYTES
    # (anyharness/crates/anyharness-lib/src/domains/mobility/model.rs:13) so the
    # server can size-guard an archive before proxying it to a sandbox runtime.
    workspace_move_max_archive_bytes: int = 128 * 1024 * 1024
