...
# External-action approvals are deliberately short-lived. A fresh identical
# request may be created after this window, but an expired approval can never
# be revived or consumed.
CLOUD_INTEGRATION_ACTION_APPROVAL_TTL_SECONDS: Final = 600
