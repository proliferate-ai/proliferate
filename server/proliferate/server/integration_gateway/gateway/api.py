...
from proliferate.server.integration_gateway.gateway.dependencies import (
    IntegrationGatewayGrant,
    require_integration_gateway_grant,
)
from proliferate.server.integration_gateway.gateway.domain import json_rpc
...
from proliferate.server.integration_gateway.gateway.service import (
