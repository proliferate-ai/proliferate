...
from proliferate.server.cloud.mcp_custom_definitions.api import (
    router as mcp_custom_definitions_router,
)
...
router.include_router(mcp_custom_definitions_router)
