...
Use this skill to look up and interpret Hugging Face paper pages.

1. Resolve the paper URL, arXiv id, or search query.
2. Fetch paper metadata and linked models, datasets, Spaces, code, or project pages when available.
