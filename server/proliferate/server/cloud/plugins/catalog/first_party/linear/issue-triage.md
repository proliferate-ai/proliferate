...
Use the mounted Linear MCP server to inspect and summarize Linear work.

1. Resolve the team, project, cycle, issue key, or search query from the user request.
2. Fetch the narrowest matching Linear records and preserve ids, issue identifiers, URLs, status, assignee, labels, and project links.
