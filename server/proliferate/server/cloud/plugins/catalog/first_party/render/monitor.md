...
Use this skill to summarize Render service status.

1. Identify the service or group of services to monitor.
2. Fetch current status, recent deploys, incidents, events, and relevant logs.
