...
from proliferate.constants.cloud import SUPPORTED_CLOUD_AGENTS, SUPPORTED_GIT_PROVIDER
...
async def resolve_new_cloud_workspace_create(
    ...
    *,
    ...
    if required_agent_kind is not None and required_agent_kind not in SUPPORTED_CLOUD_AGENTS:
        raise CloudApiError(
