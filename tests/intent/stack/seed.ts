// Seeding helpers: password accounts, orgs, invitations, and narrowly scoped
// direct-DB seeds for state the product exposes no setup API for (for example
// invitation time travel and fixture product readiness). Nothing here fakes a
// sandbox, an LLM, or any third party.
