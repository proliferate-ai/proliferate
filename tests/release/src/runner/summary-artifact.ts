/**
 * Strict product-wide release-evidence summary.
 *
 ...
 * unsigned or under-populated artifact can never pass a promotion check.
 */
...
import { requiredKey } from "./release-policy.js";

/** Placeholder for an identity field CI has not populated. Fails release validation. */
export const UNKNOWN = "unknown";

/**
 * Environment-variable interface for the signed identity fields. Trusted CI wires
...
export const SUMMARY_ENV: Readonly<Record<string, string>> = {
  headSha: "RELEASE_E2E_EVIDENCE_HEAD_SHA",
  serverSha: "RELEASE_E2E_EVIDENCE_SERVER_SHA",
  serverImageDigest: "RELEASE_E2E_EVIDENCE_SERVER_IMAGE_DIGEST",
  desktopArtifactDigest: "RELEASE_E2E_EVIDENCE_DESKTOP_ARTIFACT_DIGEST",
  desktopUpdaterManifestDigest: "RELEASE_E2E_EVIDENCE_DESKTOP_UPDATER_MANIFEST_DIGEST",
  runtimeVersion: "RELEASE_E2E_EVIDENCE_RUNTIME_VERSION",
  workerVersion: "RELEASE_E2E_EVIDENCE_WORKER_VERSION",
  templateRef: "RELEASE_E2E_EVIDENCE_TEMPLATE_REF",
  schemaMigration: "RELEASE_E2E_EVIDENCE_SCHEMA_MIGRATION",
  ciRunId: "RELEASE_E2E_EVIDENCE_CI_RUN_ID",
  stagingDeployRunId: "RELEASE_E2E_EVIDENCE_STAGING_DEPLOY_RUN_ID",
};
 ...
 * Promotion consumers reuse this validation before accepting evidence.
 */
