/**
 * Live-scenario execution policy: correlation, deadline, and the
 * no-retry-after-external-effect invariant shared by every Tier 3/4 lane.
 *
 ...
 * release-policy.test.ts so a future retry loop cannot be added silently.
 */
 ...
 * regression is caught by release-policy.test.ts.
 */
