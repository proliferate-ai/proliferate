 ...
 * specs/TESTING/scenarios.md#T3-CFG-1 (legacy diagnostic) and
 * specs/TESTING/tier-3-scenario-contract.md#local-4 (LOCAL-4).
 *
...
export const t3Cfg1: MatrixScenarioDefinition = {
  ...
  registryFlowRef: "specs/TESTING/scenarios.md#T3-CFG-1",
  lanes: ["local"],
  requiredEnv: [],
  kind: "matrix",
  expandCells: ({ agents }) =>
