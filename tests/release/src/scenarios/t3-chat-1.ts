 ...
 * tests/release/core-release-scenario-manifest.json#T3-CHAT-1
 *
 * First real matrix consumer of the exact-cell contract
 * (delivery/testing-cicd/archive/core-release-validation.md; historically the
...
export const t3Chat1: MatrixScenarioDefinition = {
  ...
  registryFlowRef: "tests/release/core-release-scenario-manifest.json#T3-CHAT-1",
  lanes: ["local", "sandbox"],
  requiredEnv: [],
  kind: "matrix",
