 ...
 * Shipped mechanics: specs/areas/anyharness.md.
 * Target guarantee: delivery/testing-cicd/archive/tier-4-scenario-contract.md.
 *
...
export const t4Cloud1: ScenarioDefinition = {
  ...
  registryFlowRef: "tests/release/core-release-scenario-manifest.json#T4-CLOUD-1",
  lanes: ["sandbox"],
