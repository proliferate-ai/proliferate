...
export const sessionTypeEnum = pgEnum("session_type", ["coding", "setup"]);
export const sessionHarnessType = pgEnum("session_harness_type", [
	"opencode",
	"claude",
	"codex",
	"amp",
...
export const sessions = pgTable(
	"sessions",
	{
		...
		sessionType: sessionTypeEnum("session_type").default("coding").notNull(),
		...
		harnessType: sessionHarnessType("harness_type").notNull(),
