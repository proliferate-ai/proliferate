...
export const prebuilds = configurations;
...
/** @deprecated To be dropped in vNext. Use `secretFiles` + `configurationSecrets` instead. */
...
export const configurationRepos = pgTable(
	"prebuild_repos",
	{
		configurationId: uuid("prebuild_id").notNull(),
		repoId: uuid("repo_id").notNull(),
...
/** @deprecated Use `configurationRepos` instead */
export const prebuildRepos = configurationRepos;
