...
use proliferate_diagnostics_protocol::v1::{
    ...
    types::{
        ArgumentValueV1, CanonicalLifecycleV1, DetailedDiagnosticV1, DetailedKindV1,
        LifecyclePhaseV1, ModelMetadataV1, PrivacyClassificationV1, ProducerRecordV1,
        RecordClassV1, RedactionClassificationV1, TerminalOutcomeV1, TypedArgumentV1,
    },
...
use crate::{
    lifecycle::{classifications, safe_fields},
    DetailedDiagnosticInput, DiagnosticArgument, DiagnosticCorrelation, DiagnosticPrivacy,
    DiagnosticsComponent, LifecycleArgument, LifecycleDiagnosticInput,
};
...
impl RecordFactory {
    ...
    fn prepare_lifecycle(&self, mut input: LifecycleDiagnosticInput) -> Result<PreparedRecord, ()> {
