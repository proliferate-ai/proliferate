...
use anyharness_contract::v1::{
    ...
    ConfigOptionUpdatePayload, ContentPart, CreatePullRequestRequest, CreatePullRequestResponse,
    CoworkArtifactDetailResponse, CoworkArtifactManifestResponse, CoworkArtifactSummary,
    CoworkArtifactType, CoworkRoot, CoworkStatus, CoworkThread, CreateCoworkThreadRequest,
    CreateCoworkThreadResponse, CreateSessionRequest, CreateWorkspaceRequest,
    CreateWorktreeWorkspaceRequest, CreateWorktreeWorkspaceResponse, CurrentModeUpdatePayload,
    CurrentPullRequestResponse, DetectProjectSetupResponse, EditPendingPromptRequest, ErrorEvent,
    ...
    HealthResponse, InstallAgentRequest, InstallAgentResponse, ItemCompletedEvent, ItemDeltaEvent,
    InstallWorkspaceMobilityArchiveRequest, InstallWorkspaceMobilityArchiveResponse,
    ItemStartedEvent, LoginCommand, MobilityPendingConfigChangeRecord,
    ...
    MobilitySessionRecord, ModelEntry, ModelRegistry, ModelRegistryModel,
    NormalizedSessionControl, NormalizedSessionControlValue, NormalizedSessionControls,
    PendingApprovalSummary, PendingPromptAddedPayload, PendingPromptRemovalReason,
    PendingPromptRemovedPayload, PendingPromptSummary, PendingPromptUpdatedPayload,
    PermissionDecision, PermissionOutcome, PermissionRequestedEvent, PermissionResolvedEvent,
    PlanEntry, ProblemDetails, PromptInputBlock, PromptSessionRequest, PromptSessionResponse,
    ...
    WorkspaceKind, WorkspaceMobilityArchive, WorkspaceMobilityBlocker,
    WorkspaceMobilityCleanupRequest, WorkspaceMobilityCleanupResponse,
    WorkspaceMobilityFileEntry, WorkspaceMobilityPreflightResponse,
    ...
    WorkspaceSurface, ExportWorkspaceMobilityArchiveRequest,
};
...
#[openapi(
    ...
    paths(
        ...
        super::http::mobility::cleanup_workspace_mobility,
