...
use anyharness_contract::v1::{
    ...
    GoalMetPayload, GoalStatus, GoalUpdatedPayload, HandoffPlanRequest, HandoffPlanResponse,
    HealthResponse, InstallAgentRequest, InstallAgentResponse,
    ...
    SetupScriptExecution, SetupScriptStatus, StagePatchRequest, StagePathsRequest, StartAgentLoginRequest,
