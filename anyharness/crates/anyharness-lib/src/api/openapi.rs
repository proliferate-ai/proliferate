...
use anyharness_contract::v1::{
    ...
    AgentLaunchOption, AgentLaunchOptionsResponse, AgentModelRegistryModel,
    ...
    ReconcileOutcome, RefreshAgentModelRegistryRequest, RefreshAgentModelRegistryResponse,
    ...
    ReviewRunUpdatedPayload, RunCommandRequest, RunCommandResponse, RuntimeArtifactCacheEntry,
    RuntimeArtifactFulfillment, RuntimeArtifactKind, RuntimeArtifactRef, RuntimeCapabilities,
    RuntimeConfigOwnerScope, RuntimeConfigPrefetchRequest, RuntimeConfigPrefetchResponse,
    RuntimeConfigResolutionProblem, RuntimeConfigResolutionReason, RuntimeConfigSource,
    RuntimeCredentialFulfillment, RuntimeCredentialKind, RuntimeCredentialRef, RuntimeMcpEnvVar,
    RuntimeMcpHeader, RuntimeMcpHttpLaunch, RuntimeMcpLaunch, RuntimeMcpQueryParam,
    RuntimeMcpServer, RuntimeMcpStdioLaunch, RuntimeResolutionFulfillRequest,
    RuntimeResolutionRejectRequest, RuntimeResolutionRequest, RuntimeResolutionRequestKind,
    RuntimeSkill, RuntimeSkillResource, RuntimeTextTemplate, RuntimeTextTemplatePart,
    ...
    StartAgentLoginResponse, StartCodeReviewRequest, StartPlanReviewRequest,
    StartTerminalCommandRequest, StartTerminalCommandResponse, StartWorkspaceSetupRequest,
    StatWorkspaceFileResponse, StopReason, SubagentCompletionSummary, SubagentTurnCompletedPayload,
    SubagentTurnOutcome, TargetRuntimeConfigApplyResponse, TargetRuntimeConfigRefreshRequest,
    TargetRuntimeConfigResponse, TargetRuntimeConfigRevision, TerminalCommandOutputMode,
...
#[openapi(
    ...
    paths(
        ...
        super::http::runtime_config::put_runtime_config,
        super::http::runtime_config::prefetch_runtime_config,
        super::http::runtime_config::list_runtime_config_resolution_requests,
        super::http::runtime_config::fulfill_runtime_config_resolution_request,
        super::http::runtime_config::reject_runtime_config_resolution_request,
        ...
        super::http::workspaces::retire_workspace_preflight,
        super::http::workspaces::retire_workspace,
        super::http::workspaces::retry_retire_cleanup,
        super::http::workspaces::purge_workspace_preflight,
        super::http::workspaces::purge_workspace,
        super::http::workspaces::retry_purge_workspace,
        ...
        super::http::sessions::fork_session,
