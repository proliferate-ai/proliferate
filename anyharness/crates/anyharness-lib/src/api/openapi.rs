...
use anyharness_contract::v1::{
    ...
    SubagentTurnOutcome, TerminalCommandOutputMode, TerminalCommandRunDetail,
    TerminalCommandRunStatus, TerminalCommandRunSummary, TerminalLifecycleEvent, TerminalPurpose,
