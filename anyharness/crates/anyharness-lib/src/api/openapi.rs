...
use anyharness_contract::v1::{
    ...
    PrepareRepoRootMobilityDestinationResponse, PrepareStopRequest, PrepareStopResponse,
    ...
    RunCommandRequest, RunCommandResponse, RuntimeActivityResponse, RuntimeActor,
    RuntimeCapabilities, RuntimeCommandAcceptance, RuntimeCommandMetadata,
    RuntimeCommandPreconditions, RuntimeCommandStatus, RuntimeInventoryCapabilities,
    RuntimeInventoryResponse, RuntimeOperationCount, RuntimeReadinessEntry, RuntimeReadinessState,
    RuntimeToolVersions, RuntimeWorkspaceRoot, SafeStopBlocker, SafeStopBlockerCode, SafeStopState,
...
#[openapi(
    ...
    paths(
        ...
        super::http::runtime::get_runtime_inventory,
        super::http::runtime::get_runtime_activity,
        super::http::runtime::prepare_runtime_stop,
