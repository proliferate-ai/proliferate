use anyharness_contract::v1::{
    ...
    AgentCatalogVersionResponse, AgentSummary, ApplyAgentAuthStateResponse, ArtifactStatus,
    ...
    OriginKind, OwnedAgentSummary, ParentSubagentLinkSummary, PendingInteractionPayloadSummary,
    ...
    ProblemDetails, PromoteSubagentRequest, PromoteSubagentResponse, PromptInputBlock,
    PromptProvenance, PromptSessionRequest, PromptSessionResponse, PromptSessionStatus,
    ProposedPlanDecisionState, ProposedPlanDetail, ProposedPlanDocumentResponse,
    ProposedPlanNativeResolutionState, ProposedPlanSummary, PruneOrphanWorktreeRequest,
    PullRequestChecksState, PullRequestReviewDecision,
    ...
    RepoRoot, RepoRootKind, RepoRootMaterializationMode, RepoRootMaterializationOutcome,
    RepositoryProvider, ResizeTerminalRequest, ResolveInteractionRequest,
    ResolveRepoRootFromPathRequest, ResolveWorkspaceFromPathRequest, ResolveWorkspaceResponse,
    RestoreWorktreeWorkspaceOutcome, RestoreWorktreeWorkspaceResponse, ResumeSessionRequest,
    ...
    RuntimeDiskPressure, RuntimeMemoryPressure, RuntimePressureLevel, RuntimeResourcePressure,
    ScheduleAgentWakeRequest, ScheduleAgentWakeResponse, ScheduleSubagentWakeRequest,
    ScheduleSubagentWakeResponse, SearchWorkspaceFilesResponse,
    ...
    WorkflowRunStatus, WorkflowRunStep, WorkflowRunStepStatus, WorkflowRunWorkspaceResponse,
    WorkflowWorkspacePlacementRequest, WorkflowWorkspaceResolvedPlacement, WorkflowWorkspaceStatus,
    Workspace, WorkspaceAvailability, WorkspaceCleanupOperation, WorkspaceExecutionPhase,
    WorkspaceExecutionSummary, WorkspaceFileEntry, WorkspaceFileKind, WorkspaceFileSearchResult,
    WorkspaceKind, WorkspaceMaterializationOutcome, WorkspaceMobilityArchive,
    WorkspaceMobilityBlocker, WorkspaceMobilityFileEntry, WorkspaceMobilityPreflightResponse,
    WorkspaceMobilityRuntimeMode, WorkspaceMobilityRuntimeState, WorkspaceMobilitySessionBundle,
...
#[openapi(
    ...
    paths(
        ...
        super::http::sessions_wakes::schedule_agent_wake,
