...
use anyharness_contract::v1::{
    ...
    NormalizedSessionControlValue, NormalizedSessionControls, PendingInteractionPayloadSummary,
    ...
    PromptSessionStatus, ProposedPlanDecisionState, ProposedPlanDetail,
    ...
    SessionExecutionSummary, SessionInfoUpdatePayload, SessionLiveConfigSnapshot, SessionMcpEnvVar,
    SessionMcpHeader, SessionMcpHttpServer, SessionMcpServer, SessionMcpStdioServer,
    SessionRawNotificationEnvelope, SessionStartedEvent, SessionStateUpdatePayload, SessionStatus,
    ...
    StartAgentLoginResponse, StartWorkspaceSetupRequest, StopReason, TerminalLifecycleEvent,
