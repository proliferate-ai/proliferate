...
use anyharness_contract::v1::{
    ...
    InstallAgentResponse, InstallWorkspaceMobilityArchiveRequest,
    ...
    LoginCommand, MarkReviewRevisionReadyRequest, McpElicitationBooleanField, McpElicitationField,
    ...
    PlanDecisionResponse, PlanEntry, PlanHandoffPromptStatus, PlanNativeOptionDecisionRequest,
    PlanNativeOptionDecisionResponse, PrepareRepoRootMobilityDestinationRequest,
    ...
    ProposedPlanSummary, PruneOrphanWorktreeRequest, PullRequestState, PullRequestSummary,
    PushRequest, PushResponse, PushRevokedJtisRequest, PushRevokedJtisResponse,
    ...
    ReplayRecordingSummary, RepoRoot, RepoRootKind, ResizeTerminalRequest,
    ...
    RuntimeConfigStatusResponse, RuntimeCredentialRef, RuntimeCredentialUse,
    ...
    RuntimeMcpTransport, RuntimeMcpValue, RuntimeSkill, RuntimeSkillSourceKind,
    ...
    SessionLinkSummary, SessionLiveConfigSnapshot, SessionMcpBindingNotAppliedReason,
    SessionMcpBindingOutcome, SessionMcpBindingSummary, SessionMcpEnvVar, SessionMcpHeader,
    SessionMcpHttpServer, SessionMcpServer, SessionMcpStdioServer, SessionMcpTransport,
    SessionRawNotificationEnvelope, SessionReviewsResponse, SessionStartedEvent,
    SessionStateUpdatePayload, SessionStatus, SessionSubagentsResponse,
    SetSessionConfigOptionRequest, SetSessionConfigOptionResponse, SetupHint, SetupHintCategory,
    SetupScriptExecution, SetupScriptStatus, StagePathsRequest, StartAgentLoginRequest,
    StartAgentLoginResponse, StartAgentLoginTerminalResponse, StartCodeReviewRequest,
    StartPlanReviewRequest, StartTerminalCommandRequest, StartTerminalCommandResponse,
    StartWorkspaceSetupRequest, StatWorkspaceFileResponse, StopReason, SubagentCompletionSummary,
    SubagentTurnCompletedPayload, SubagentTurnOutcome, TerminalCommandOutputMode,
    TerminalCommandRunDetail, TerminalCommandRunStatus, TerminalCommandRunSummary,
    TerminalLifecycleEvent, TerminalPurpose, TerminalRecord, TerminalStatus,
    TranscriptItemDeltaPayload, TranscriptItemKind, TranscriptItemPayload, TranscriptItemStatus,
    TurnEndedEvent, TurnStartedEvent, UnstagePathsRequest, UpdateSessionTitleRequest,
    UpdateTerminalTitleRequest, UpdateWorkspaceDisplayNameRequest,
...
#[openapi(
    ...
    paths(
        ...
        super::http::plans::resolve_plan_native_option,
