use anyharness_contract::v1::{
    ...
    AgentAuthProbePhase, AgentAuthSelectionFact, AgentAuthStateSummary, AgentCatalogVersionResponse,
    ...
    ClearSessionGoalResponse, ClearSessionLoopsResponse, CommitRequest,
    ...
    WorkspaceKind, WorkspaceLifecycleFilter, WorkspaceMaterializationOutcome,
    ...
    WorkspaceMobilitySessionCandidate, WorkspacePurgeOutcome,
