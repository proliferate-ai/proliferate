...
use anyharness_contract::v1::{
    ...
    ProviderConfig, PruneOrphanWorktreeRequest, PullRequestState, PullRequestSummary, PushRequest,
    PushResponse, RawSessionConfigOption, RawSessionConfigValue, ReadWorkspaceFileResponse,
    ReasoningVisibility, ReconcileAgentResult, ReconcileAgentsRequest, ReconcileAgentsResponse,
    ReconcileJobStatus, ReconcileOutcome, RenameWorkspaceFileEntryRequest,
    ...
    RunCommandRequest, RunCommandResponse, RuntimeCapabilities, ScheduleSubagentWakeRequest,
    ...
    WorkspaceRetireResponse, WorkspaceSessionLaunchAgent, WorkspaceSessionLaunchCatalog,
    ...
    WorkspaceSessionLaunchModel, WorkspaceSurface, WorktreeInventoryAction,
    WorktreeInventoryResponse, WorktreeInventoryRow, WorktreeInventoryState,
    WorktreeInventoryWorkspaceSummary, WriteWorkspaceFileRequest, WriteWorkspaceFileResponse,
};
...
#[openapi(
    ...
    paths(
        ...
        super::http::workspaces::get_effective_agent_launch_catalog,
