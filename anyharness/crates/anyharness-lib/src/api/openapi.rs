...
use anyharness_contract::v1::{
    ...
    ReconcileJobStatus, ReconcileOutcome, ReplayRecordingSummary, RepoRoot, RepoRootKind,
    ...
    RunCommandRequest, RunCommandResponse, RuntimeCapabilities, Session, SessionActionCapabilities,
    ...
    StartWorkspaceSetupRequest, StopReason, SubagentCompletionSummary,
