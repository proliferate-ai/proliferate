...
use anyharness_contract::v1::{
    ...
    CreateSessionRequest, CreateWorkspaceRequest, CreateWorktreeWorkspaceRequest,
    ...
    DetectProjectSetupResponse, EditPendingPromptRequest, ErrorEvent, ExportReplayRecordingRequest,
    ExportReplayRecordingResponse, ExportWorkspaceMobilityArchiveRequest, FileChangeOperation,
    FileOpenTarget, FileReadScope, GetSessionLiveConfigResponse, GetSetupStatusResponse,
    GitActionAvailability, GitBranchRef, GitChangedFile, GitDiffResponse, GitFileStatus,
    GitIncludedState, GitOperation, GitStatusSnapshot, GitStatusSummary, HandoffPlanRequest,
    ...
    LoginCommand, McpElicitationBooleanField, McpElicitationField, McpElicitationFieldBase,
    ...
    SubagentTurnCompletedPayload, SubagentTurnOutcome, TerminalLifecycleEvent,
