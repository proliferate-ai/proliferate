...
use anyharness_contract::v1::{
    ...
    ListProposedPlansResponse, LoginCommand, McpElicitationBooleanField, McpElicitationField,
    ...
    RepoRoot, RepoRootKind, ResolveInteractionRequest, ResolveRepoRootFromPathRequest,
    ResolveWorkspaceFromPathRequest, ResolveWorkspaceResponse, RunCommandRequest,
    RunCommandResponse, Session, SessionEndReason, SessionEndedEvent, SessionEvent,
    SessionEventEnvelope, SessionExecutionPhase, SessionExecutionSummary, SessionInfoUpdatePayload,
    SessionLiveConfigSnapshot, SessionMcpEnvVar, SessionMcpHeader, SessionMcpHttpServer,
    SessionMcpServer, SessionMcpStdioServer, SessionRawNotificationEnvelope, SessionStartedEvent,
    SessionStateUpdatePayload, SessionStatus, SetSessionConfigOptionRequest,
