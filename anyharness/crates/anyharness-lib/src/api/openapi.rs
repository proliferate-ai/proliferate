...
use anyharness_contract::v1::{
    ...
    ItemDeltaEvent, ItemStartedEvent, LoginCommand, McpElicitationBooleanField,
    ...
    PermissionInteractionOptionKind, PermissionInteractionPayload, PlanEntry,
    ...
    ReconcileOutcome, RepoRoot, RepoRootKind, ResolveInteractionRequest,
