...
use anyharness_contract::v1::{
    ...
    ApplyAgentAuthConfigRequest, ApplyAgentAuthConfigResponse, ApplyRuntimeConfigRequest,
    ApplyRuntimeConfigResponse, ArtifactStatus, AvailableCommandsUpdatePayload,
