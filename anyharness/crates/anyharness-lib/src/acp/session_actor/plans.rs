...
pub(super) async fn maybe_ingest_codex_completed_plan(
...
pub(super) async fn maybe_ingest_tagged_completed_plan(
    event_sink: &Arc<Mutex<SessionEventSink>>,
    plan_service: &PlanService,
    review_service: Option<&ReviewService>,
    session_id: &str,
...
pub(super) async fn maybe_ingest_claude_exit_plan(
    event_sink: &Arc<Mutex<SessionEventSink>>,
    plan_service: &PlanService,
    review_service: Option<&ReviewService>,
    session_id: &str,
...
pub(super) fn extract_tagged_proposed_plan(value: &str) -> Option<String> {
...
pub(super) fn title_from_markdown(value: &str) -> Option<String> {
    value
        .lines()
        .map(str::trim)
