...
fn durable_prompt_start_failure_code(error: &StartSessionError) -> &'static str {
    match error {
        ...
        StartSessionError::LaunchOptionsUnavailable { .. } => "launch_options_unavailable",
        StartSessionError::LaunchValueUnsupported { .. } => "launch_value_unsupported",
        StartSessionError::AgentEnvOverrideUnsupported { .. } => "agent_env_override_unsupported",
