...
use crate::domains::sessions::mcp_bindings::injection::{
    inject_product_mcps, ProductMcpInjectionContext,
};
use crate::domains::sessions::mcp_bindings::product_launch::ProductMcpLaunchRegistration;
use crate::domains::sessions::mcp_bindings::selection::select_product_mcps;
