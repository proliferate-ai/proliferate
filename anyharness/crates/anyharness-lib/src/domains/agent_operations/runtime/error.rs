...
pub enum AgentOperationsError {
    ...
    #[error("workspace pin event delivery is not configured")]
    WorkspacePinEventsUnavailable,
...
impl AgentOperationsError {
    pub fn code(&self) -> &'static str {
        match self {
            ...
            Self::WorkspacePinEventsUnavailable => "AGENT_OPERATIONS_UNAVAILABLE",
    ...
    pub fn public_message(&self) -> String {
        match self {
            ...
            Self::WorkspacePinEventsUnavailable => {
                "Workspace UI requests are unavailable.".into()
            }
